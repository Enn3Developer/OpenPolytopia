...
namespace SpacetimeDB.Types {
  ...
  public sealed partial class RemoteTables : RemoteTablesBase {
    public RemoteTables(DbConnection conn) {
      AddTable(Lobby = new(conn));
      AddTable(LobbyPlayer = new(conn));
      AddTable(Player = new(conn));
      AddTable(StartLobbySchedule = new(conn));
    }
  }
  ...
  public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer> {
    ...
    protected override Reducer ToReducer(TransactionUpdate update) {
      ...
      return update.ReducerCall.ReducerName switch {
        "AddReady" => BSATNHelpers.Decode<Reducer.AddReady>(encodedArgs),
        ...
        "CreateLobby" => BSATNHelpers.Decode<Reducer.CreateLobby>(encodedArgs),
        "JoinLobby" => BSATNHelpers.Decode<Reducer.JoinLobby>(encodedArgs),
        "LeaveLobby" => BSATNHelpers.Decode<Reducer.LeaveLobby>(encodedArgs),
        "RemoveReady" => BSATNHelpers.Decode<Reducer.RemoveReady>(encodedArgs),
        "SetName" => BSATNHelpers.Decode<Reducer.SetName>(encodedArgs),
        "StartLobby" => BSATNHelpers.Decode<Reducer.StartLobby>(encodedArgs),
    ...
    protected override bool Dispatch(IReducerEventContext context, Reducer reducer) {
      ...
      return reducer switch {
        Reducer.AddReady args => Reducers.InvokeAddReady(eventContext, args),
        ...
        Reducer.CreateLobby args => Reducers.InvokeCreateLobby(eventContext, args),
        Reducer.JoinLobby args => Reducers.InvokeJoinLobby(eventContext, args),
        Reducer.LeaveLobby args => Reducers.InvokeLeaveLobby(eventContext, args),
        Reducer.RemoveReady args => Reducers.InvokeRemoveReady(eventContext, args),
        Reducer.SetName args => Reducers.InvokeSetName(eventContext, args),
        Reducer.StartLobby args => Reducers.InvokeStartLobby(eventContext, args),
